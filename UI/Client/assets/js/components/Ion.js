               ...
               if ((c = c.prop("value")))
                 (c = c.split(";")),
                   ...
                   b && b.values && b.values.length
                     ? ((a.from = c[0] && b.values.indexOf(c[0])), (a.to = c[1] && b.values.indexOf(c[1])))
             ...
             q.prototype = {
               ...
               calc: function(a) {
                 if (this.options) {
                   ...
                   if (this.coords.w_rs) {
                     ...
                     "click" === this.target &&
                       ((this.coords.p_gap = this.coords.p_handle / 2), (b = this.toFixed(this.coords.p_pointer - this.coords.p_gap)), (this.target = this.chooseHandle(b)));
                     0 > b ? (b = 0) : b > a && (b = a);
                     switch (this.target) {
                       case "base":
               ...
               drawShadow: function() {
                 var a = this.options,
                   ...
                   f = "number" === typeof a.to_min && !isNaN(a.to_min),
                   g = "number" === typeof a.to_max && !isNaN(a.to_max);
                 "single" === a.type
                   ? a.from_shadow && (c || d)
                     ? ((c = this.calcPercent(c ? a.from_min : a.min)),
                       (d = this.calcPercent(d ? a.from_max : a.max) - c),
                   ...
                   : (a.from_shadow && (c || d)
                     ...
                     a.to_shadow && (f || g)
                       ? ((f = this.calcPercent(f ? a.to_min : a.min)),
                         (a = this.calcPercent(g ? a.to_max : a.max) - f),
               ...
               validate: function() {
                 ...
                 if (d)
                   for (a.p_values = [], a.min = 0, a.max = d - 1, a.step = 1, a.grid_num = a.max, a.grid_snap = !0, g = 0; g < d; g++)
                     (f = +c[g]), isNaN(f) ? (f = c[g]) : ((c[g] = f), (f = this._prettify(f))), a.p_values.push(f);
               ...
               calcGridLabels: function() {
                 ...
                 this.options.force_edges &&
                   (b[0] < -this.coords.grid_gap &&
                     ((b[0] = -this.coords.grid_gap), (c[0] = this.toFixed(b[0] + this.coords.big_p[0])), (this.coords.big_x[0] = this.coords.grid_gap)),
               ...
               destroy: function() {
                 this.input &&
                   (this.toggleInput(), this.$cache.input.prop("readonly", !1), e.data(this.input, "ionRangeSlider", null), this.remove(), (this.options = this.input = null));
               },
             };
